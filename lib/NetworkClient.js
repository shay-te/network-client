var NetworkClient = function(defaultConfigOverride){
	 ...
	 *
	 **/
    var _default_request_config = { baseURL: "", json: false, headers: {}, retries: 0, backOffFactor: 0, store: false, storeExpiration: 0, debug: false};
   ...
   */
    ...
    var _fireNetworkEnd = function(method, url, data, config) { _fireEventByKey("networkEnd", method, url, data, config); }
    var _fireNetworkError = function(method, url, data, config) { _fireEventByKey("networkError", method, url, data, config); }
    var _fireNetworkStorage = function(method, url, data, config) { _fireEventByKey("networkStorage", method, url, data, config); }
    var _fireEventByKey = function(eventKey, method, url, data, config) {
